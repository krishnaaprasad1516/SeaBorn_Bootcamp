...
st.title('mr krishna seaborn bootcamp tips data visualization app')
...
def reg_plot(ax):
    ...
    ax.set_title("Regresssion plot of Total Bill vs Tip") 
...
def pair_plot(ax):
    ...
    ax.set_title("pair plot:numeric variables by gender", y =1.02)  
...
display_plot("scater plot", scatter_plot)
display_plot("Line plot",line_plot)  
display_plot("Bar plot", bar_plot)
display_plot("Boxplot", box_plot)
